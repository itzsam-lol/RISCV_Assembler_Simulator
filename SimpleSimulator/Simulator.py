...
class Simulator:
    ...
    def execute_line(self, inst_bin):
        ...
        if itype == 'R':
            ...
            if funct3 == "000": taken = (v1_s == v2_s)
            elif funct3 == "001": taken = (v1_s != v2_s)
            elif funct3 == "100": taken = (v1_s < v2_s)
            elif funct3 == "101": taken = (v1_s >= v2_s)
            elif funct3 == "110": taken = (v1_u < v2_u)
            elif funct3 == "111": taken = (v1_u >= v2_u)
            if taken:
                next_pc = self.pc + imm
